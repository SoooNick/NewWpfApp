        ...
        public static IList<Doctor> Doctors
        {
            get
            {
                if(_doctors == null)
                {
                    ...
                    _doctors.Add(new Doctor("Jan", "Kowalski", Enums.DoctorDegree.Doctor, Enums.Specialization.Dentist));
                    _doctors.Add(new Doctor("Adam", "Nowak", Enums.DoctorDegree.Professor, Enums.Specialization.GP));
                }
                return _doctors;
            }
        }
